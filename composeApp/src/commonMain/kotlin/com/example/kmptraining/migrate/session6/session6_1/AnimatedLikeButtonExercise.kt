package com.example.kmptraining.migrate.session6.session6_1
    ...
    Column(
        ...
        Spacer(modifier = Modifier.height(32.dp))
         ...
         val color by animateColorAsState(
             ...
             animationSpec = spring(stiffness = Spring.DampingRatioMediumBouncy)
         )
...
private fun AnimatedLikeButtonPreview() {
    ComposeTrainingTheme { AnimatedLikeButton() }
}
