package com.example.kmptraining.migrate.session5.session5_1
...
import com.example.kmptraining.migrate.session5.session5_1.route.HomeKey
import com.example.kmptraining.migrate.session5.session5_1.route.WelcomeKey
import com.example.kmptraining.migrate.session5.session5_1.screens.HomeScreen
    ...
    val navConfig = SavedStateConfiguration {
        serializersModule = SerializersModule {
            polymorphic(NavKey::class) {
                subclass(WelcomeKey::class, WelcomeKey.serializer())
                subclass(HomeKey::class, HomeKey.serializer())
            }
        }
    }
    val backStack = rememberNavBackStack(navConfig, WelcomeKey)
