package com.example.kmptraining.migrate.session2.session2_4
...
import com.example.kmptraining.migrate.session2.session2_4.component.PricingCard
...
private fun PricingTableScreenPreview() {
    ComposeTrainingTheme { PricingTableScreen() }
}
