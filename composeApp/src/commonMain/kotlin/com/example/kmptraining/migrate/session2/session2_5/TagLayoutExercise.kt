package com.example.kmptraining.migrate.session2.session2_5
...
import com.example.kmptraining.migrate.session2.session2_5.component.TagsLayout
...
private fun TagLayoutScreenPreview() {
    ComposeTrainingTheme { TagLayoutScreen() }
}
