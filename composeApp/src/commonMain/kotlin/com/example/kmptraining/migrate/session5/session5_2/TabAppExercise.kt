package com.example.kmptraining.migrate.session5.session5_2
...
import com.example.kmptraining.migrate.session5.session5_2.component.AppBottomBar
import com.example.kmptraining.migrate.session5.session5_2.route.ArticleDetailKey
import com.example.kmptraining.migrate.session5.session5_2.route.EditProfileKey
import com.example.kmptraining.migrate.session5.session5_2.route.ExploreTabKey
import com.example.kmptraining.migrate.session5.session5_2.route.HomeTabKey
import com.example.kmptraining.migrate.session5.session5_2.route.NavigationTab
import com.example.kmptraining.migrate.session5.session5_2.route.ProfileTabKey
import com.example.kmptraining.migrate.session5.session5_2.route.SearchResultKey
import com.example.kmptraining.migrate.session5.session5_2.screens.explore.ExploreScreen
import com.example.kmptraining.migrate.session5.session5_2.screens.explore.SearchResultScreen
import com.example.kmptraining.migrate.session5.session5_2.screens.home.ArticleDetailScreen
import com.example.kmptraining.migrate.session5.session5_2.screens.home.HomeScreen
import com.example.kmptraining.migrate.session5.session5_2.screens.profile.EditProfileScreen
import com.example.kmptraining.migrate.session5.session5_2.screens.profile.ProfileScreen
    ...
    val navConfig = SavedStateConfiguration {
        serializersModule = SerializersModule {
            polymorphic(NavKey::class) {
                subclass(HomeTabKey::class, HomeTabKey.serializer())
                subclass(ArticleDetailKey::class, ArticleDetailKey.serializer())
                subclass(ExploreTabKey::class, ExploreTabKey.serializer())
                subclass(SearchResultKey::class, SearchResultKey.serializer())
                subclass(ProfileTabKey::class, ProfileTabKey.serializer())
                subclass(EditProfileKey::class, EditProfileKey.serializer())
            }
        }
    }
    val homeStack = rememberNavBackStack(navConfig, HomeTabKey)
    val exploreStack = rememberNavBackStack(navConfig, ExploreTabKey)
    val profileStack = rememberNavBackStack(navConfig, ProfileTabKey)
