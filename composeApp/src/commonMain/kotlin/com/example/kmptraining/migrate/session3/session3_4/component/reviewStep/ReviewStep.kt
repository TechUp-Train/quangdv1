...
import kmptraining.composeapp.generated.resources.review_information
import kmptraining.composeapp.generated.resources.review_information_description
...
fun ReviewStep(
    ...
    Column(
        ...
        Column {
            Text(
                stringResource(Res.string.review_information),
                style =
                    TextStyle(
                        color = Color.Black,
                        fontSize = 28.sp,
            ...
            Text(
                stringResource(Res.string.review_information_description),
                style =
                    TextStyle(
                        color = Color.Gray,
                        fontSize = 14.sp,
