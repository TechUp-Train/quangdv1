...
class HomeViewModel(
    ...
    private val _publicRepos = MutableStateFlow<ResponseStatus<List<PublicRepoModel>>>(ResponseStatus.Loading)
    val publicRepos: StateFlow<ResponseStatus<List<PublicRepoModel>>> = _publicRepos
