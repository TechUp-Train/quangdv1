...
fun GenerateImageRequest.toDto(): GenerateImageRequestDto =
...
fun GenerateImageResponseDto.toDomain(): GenerateImageModel =
    GenerateImageModel(
        url = url,
        path = path,
    )

fun PresignLinkDto.toDomain(): PresignLinkModel =
    PresignLinkModel(
        url = url,
        path = path,
    )
...
fun CategoriesItemDto.toDomain(): CategoriesItemModel =
    CategoriesItemModel(
...
fun StylesItemDto.toDomain(): StyleItemModel =
    StyleItemModel(
